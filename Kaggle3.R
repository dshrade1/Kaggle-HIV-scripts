...
# translate one or 2...
# translate sequences individually??
PR_translated[[1]] <- translate(charList_PR[[1]]) # works
PR_translated[[2]] <- translate(charList_PR[[2]])
...
PR_translated[[11]] <- translate(charList_PR[[11]]) # works
PR_translated[[12]] <- translate(charList_PR[[12]])
PR_translated[[13]] <- translate(charList_PR[[13]])
PR_translated[[14]] <- translate(charList_PR[[14]])
PR_translated[[15]] <- translate(charList_PR[[15]])
PR_translated[[16]] <- translate(charList_PR[[16]])
PR_translated[[17]] <- translate(charList_PR[[17]])
PR_translated[[18]] <- translate(charList_PR[[18]])
PR_translated[[19]] <- translate(charList_PR[[19]])
PR_translated[[20]] <- translate(charList_PR[[20]])
